jQuery(function (t) {
  ...
  t("body")
    .on("init", ".wc-tabs-wrapper, .woocommerce-tabs", function () {
      ...
      e.toLowerCase().indexOf("comment-") >= 0 || "#reviews" === e || "#tab-reviews" === e
    ...
    .on("click", ".wc-tabs li a, ul.tabs li a", function (e) {
      ...
      a.find("li").removeClass("active"),
        a.find('a[role="tab"]').attr("aria-selected", "false").attr("tabindex", "-1"),
        o.find(".wc-tab, .panel:not(.panel .panel)").hide(),
        i.closest("li").addClass("active"),
        i.attr("aria-selected", "true").attr("tabindex", "0"),
    ...
    .on("focusout", ".wc-tabs li a, ul.tabs li a, #respond p.stars a", function () {
      e.data("flexslider") &&
        setTimeout(function () {
          t(document.activeElement).closest([".stars", ".tabs", ".wc-tabs"].join(", ")).length
            ? (e.data("flexslider").animating = !0)
            : (e.data("flexslider").animating = !1);
        }, 0);
    })
    ...
    .on("click", "#respond #submit", function () {
      var e = t(this).closest("#respond").find("#rating"),
        i = e.val();
      if (e.length > 0 && !i && "yes" === wc_single_product_params.review_rating_required)
      ...
      0 !== this.$images.length
        ? (e.data("product_gallery", this),
          (this.flexslider_enabled =
            "function" == typeof t.fn.flexslider && wc_single_product_params.flexslider_enabled),
          (this.zoom_enabled = "function" == typeof t.fn.zoom && wc_single_product_params.zoom_enabled),
          (this.photoswipe_enabled = "undefined" != typeof PhotoSwipe && wc_single_product_params.photoswipe_enabled),
          i &&
            ((this.flexslider_enabled = !1 !== i.flexslider_enabled && this.flexslider_enabled),
            (this.zoom_enabled = !1 !== i.zoom_enabled && this.zoom_enabled),
            (this.photoswipe_enabled = !1 !== i.photoswipe_enabled && this.photoswipe_enabled)),
  ...
  (i.prototype.initFlexslider = function (e) {
    var i = this.$target,
      o = this,
      a = t.extend(
        {
    ...
    i.flexslider(a),
      t(".woocommerce-product-gallery__wrapper .woocommerce-product-gallery__image:eq(0) .wp-post-image")
        .one("load", function () {
          var e = t(this);
          e &&
            setTimeout(function () {
    ...
    (i.prototype.initZoom = function () {
      this.initZoomForTarget(this.$images.first());
    }),
    (i.prototype.initZoomForTarget = function (e) {
      ...
      if (
        ...
        "ontouchstart" in document.documentElement && (a.on = "click"),
    ...
    (i.prototype.onResetSlidePosition = function () {
      this.$target.flexslider(0);
    }),
    (i.prototype.getGalleryItems = function () {
      var e = this.$images,
        i = [];
      return (
        e.length > 0 &&
    ...
    (i.prototype.openPhotoswipe = function (e) {
      e.preventDefault();
      var i,
        o = t(".pswp")[0],
        ...
        n = this;
      i =
        0 < r.closest(".woocommerce-product-gallery__trigger").length
    ...
    (i.prototype.trapFocusPhotoswipe = function (t) {
    ...
    (i.prototype.handlePswpTrapFocus = function (t) {
    ...
    (t.fn.wc_product_gallery = function (t) {
      return new i(this, t || wc_single_product_params), this;
    }),
    t(".woocommerce-product-gallery").each(function () {
      t(this).trigger("wc-product-gallery-before-init", [this, wc_single_product_params]),
